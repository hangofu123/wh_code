...
BOOL CDlgGameRule::OnInitDialog()
{
	...
	try
	{
		...
		rcBrowse.bottom=rcClient.Height()-nRViewBorder;
		...
		_sntprintf(szRuleUrl,CountArray(szRuleUrl),TEXT("%s/GameRule.aspx?KindID=%ld"),szPlatformLink,pGameAttribute->wKindID);
