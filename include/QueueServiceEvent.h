...
public:
	...
	bool PostTCPSocketCloseEvent(WORD wServiceID, BYTE cbShutReason)
	{
		...
		return m_pIQueueService.AddToQueue(EVENT_TCP_SOCKET_SHUT, m_cbBuffer, sizeof(NTY_TCPNetworkShutEvent));
	}
