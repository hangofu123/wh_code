...
//绘画数字
VOID CTableViewFrame::DrawNumberString(CDC * pDC, CWHPngImage &PngNumber, LONG lNumber, INT nXPos, INT nYPos,BYTE cbAlign)
{
	//加载资源
