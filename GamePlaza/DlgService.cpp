...
VOID CDlgServiceBar::OnPaint()
{
	...
	//加载资源
	CWHPngImage ImageButton;
	CWHPngImage ImageBarLogo;
	CWHPngImage ImageBarImage;
	ImageButton.LoadImage(AfxGetInstanceHandle(),TEXT("SERVICE_BAR_BT"));
...
BOOL CDlgService::OnInitDialog()
{
	...
	//设置地址
	m_DlgServiceBrowser1.InitService(5,TEXT("会员充值"),TEXT("Pay/PayIndex.aspx"));
	m_DlgServiceBrowser2.InitService(6,TEXT("游戏记录"),TEXT("Member/GameRecord.aspx"));
	m_DlgServiceBrowser3.InitService(7,TEXT("充值记录"),TEXT("Member/PayRecord.aspx"));
	m_DlgServiceBrowser4.InitService(8,TEXT("负分清零"),TEXT("Member/ClearScore.aspx"));
	m_DlgServiceBrowser5.InitService(9,TEXT("清逃跑率"),TEXT("Member/ClearFlee.aspx"));
	m_DlgServiceBrowser6.InitService(10,TEXT("游戏会员"),TEXT("Member/MIndex.aspx"));
