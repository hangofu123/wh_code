...
VOID CGameFrameViewD3D::DrawMatchInfo(CD3DDevice * pD3DDevice)
{
	...
	if(m_strRollText!="" )
	{
		if(m_strRollText.GetLength()>=40)
		{
			m_D3DRollFont.DrawText(pD3DDevice,m_strRollText.Left(20), &m_rcText,DT_CENTER,D3DCOLOR_XRGB(255,255,255));
			CRect rcLine=m_rcText;
			rcLine.top+=25;
			if(rcLine.top<rcLine.bottom)
				m_D3DRollFont.DrawText(pD3DDevice,m_strRollText.Mid(21,40), &rcLine,DT_CENTER,D3DCOLOR_XRGB(255,255,255));
			rcLine.top+=25;
			if(rcLine.top<rcLine.bottom)
				m_D3DRollFont.DrawText(pD3DDevice,m_strRollText.Mid(41,60), &rcLine,DT_CENTER,D3DCOLOR_XRGB(255,255,255));
		}
		else if(m_strRollText.GetLength()>=20)
		{
			m_D3DRollFont.DrawText(pD3DDevice,m_strRollText.Left(20), &m_rcText,DT_CENTER,D3DCOLOR_XRGB(255,255,255));
			CRect rcLine=m_rcText;
			rcLine.top+=25;
