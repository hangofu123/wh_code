...
{
	CWHPngImage						ImageTL;							//位图对象
	CWHPngImage						ImageTM;							//位图对象
	CWHPngImage						ImageTR;							//位图对象
	CWHPngImage						ImageML;							//位图对象
	CWHPngImage						ImageMR;							//位图对象
	CWHPngImage						ImageBL;							//位图对象
	CWHPngImage						ImageBM;							//位图对象
	CWHPngImage						ImageBR;							//位图对象
};
