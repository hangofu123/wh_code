...
//加载图片
bool CWHPngImage::LoadImage(LPCTSTR pszFileName)
{
	//WIN 7 执行
	if ( CD2DEngine::GetD2DEngine() )
	{
...
//加载图片
bool CWHPngImage::LoadImage(HINSTANCE hInstance, LPCTSTR pszResourceName)
{
	//WIN 7 执行
	if ( CD2DEngine::GetD2DEngine() )
	{
...
//绘画图像
bool CWHPngImage::DrawImage(CDC * pDC, INT nXPos, INT nYPos)
{
	//WIN 7 执行
...
//绘画图像
bool CWHPngImage::DrawImage(CDC * pDC, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXScr, INT nYSrc)
{
	//WIN 7 执行
	if ( CD2DEngine::GetCurrentWnd() && CD2DEngine::GetD2DEngine() )
	{
...
//绘画图像
bool CWHPngImage::DrawImage(CDC * pDC, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXScr, INT nYSrc, INT nSrcWidth, INT nSrcHeight)
{
	//WIN 7 执行
	if ( CD2DEngine::GetCurrentWnd() && CD2DEngine::GetD2DEngine() )
	{
...
//混合绘画
bool CWHPngImage::AlphaDrawImage(CDC * pDestDC, INT xDest, INT yDest, BYTE cbAlphaDepth)
{
	//透明绘画
...
//混合绘画
bool CWHPngImage::AlphaDrawImage(CDC * pDestDC, INT xDest, INT yDest, INT cxDest, INT cyDest, INT xSrc, INT ySrc, BYTE cbAlphaDepth)
{
	//WIN 7 执行
	if ( CD2DEngine::GetCurrentWnd() && CD2DEngine::GetD2DEngine() )
	{
...
//混合绘画
bool CWHPngImage::AlphaDrawImage(CDC * pDestDC, INT xDest, INT yDest, INT cxDest, INT cyDest, INT xSrc, INT ySrc, INT cxSrc, INT cySrc, BYTE cbAlphaDepth)
{
	//WIN 7 执行
	if ( CD2DEngine::GetCurrentWnd() && CD2DEngine::GetD2DEngine() )
	{
